...
function purpleParty () {
    document.querySelector('body').style.backgroundColor = "rgba(155, 3, 160, 1)"
    document.querySelector('body').style.color = "white"
}
function greenParty () {
    document.querySelector('body').style.backgroundColor = "rgba(1, 102, 33, 1)"
    document.querySelector('body').style.color = "white"
}
function blueParty () {
    document.querySelector('body').style.backgroundColor = "rgba(12, 0, 182, 1)"
    document.querySelector('body').style.color = "white"
}
function redParty () {
